...
func NewWriteTool(workspace *Workspace) *WriteTool {
...
func (t *WriteTool) Execute(ctx context.Context, args json.RawMessage, _ ai.UpdateEmitter) (ai.ToolOutput, error) {
