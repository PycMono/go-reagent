...
func DefaultMiddlewareRegistrations() []MiddlewareRegistration {
	return []MiddlewareRegistration{
		...
		{Name: "schema_validation", Order: 30, Middleware: schemaValidationMiddleware()},
		{Name: "logging", Order: 40, Middleware: loggingMiddleware()},
		{Name: "output_limit", Order: 50, Middleware: outputLimitMiddleware()},
		{Name: "event_forwarding", Order: 60, Middleware: eventForwardingMiddleware()},
	}
}
