...
**Spec:** `docs/superpowers/specs/2026-09-04-agent-self-training-design.md`, §§4.3, 5.3, 6.3, 7, 8, 9.2, 10.1 and 11. Prerequisite plan: `docs/superpowers/plans/2026-09-09-agent-employees-phase-1b.md`. This plan starts after its acceptance gate and does not assume proposed Phase 1B signatures already exist in the checkout.
